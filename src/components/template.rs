    ...
    html! { (DOCTYPE)
        html lang="en" {
            head {
                ...
                link rel="preload" as="script" href="/static/3p/js/alpine-morph.min.js";
                link rel="preload" as="script" href="/static/3p/js/alpine.min.js";
                script defer src="/static/3p/js/alpine-morph.min.js" {}
                script defer src="/static/3p/js/alpine.min.js" {}
