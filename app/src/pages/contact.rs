...
impl Message {
    ...
    fn thanks_message(&self) -> Markup {
        html!(div class="rounded border border-slate-500 bg-gray-800 p-4 text-center" {
    ...
    Ok((
            ...
            .unwrap_or(false)
        {
            ...
            template(
                ...
                html!((Header::Floating(None))(margins(body.thanks_message()))),
            )
        },
    ))
}
